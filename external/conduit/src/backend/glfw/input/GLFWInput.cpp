...
void conduit::glfw::input::pollKeyboard(const conduit::glfw::GLFWWindow &pWindow, KeyboardState &keyboardState)
{
...
void conduit::glfw::input::pollMouse(const conduit::glfw::GLFWWindow &pWindow, MouseState &mouseState)
{
...
namespace {
    ...
    void pollAxesAndButtons(int gamepad, conduit::GamepadState &state)
    {
        ...
        {   
            ...
            conduit::glfw::glfwGamepadAxis glfw_axis = conduit::glfw::toGLFWGamepadAxis(conduit_axis);
        ...
        for (conduit::sizet button = 0; button < static_cast<conduit::sizet>(conduit::GamepadButton::MAX_COUNT); ++button)
        {
            ...
            conduit::glfw::glfwGamepadButton glfw_button = conduit::glfw::toGLFWGamepadButton(conduit_button);
